...
COMPILE = cc -Wall -Wextra -Werror \
		-L/home/kali/.brew/opt/readline/lib -I/home/kali/.brew/opt/readline/include \
		-lreadline \
...
# obj dirs
OBJ_DIRS=$(OBJ_DIR)/$(PROT) $(OBJ_DIR)/$(HLP) $(OBJ_DIR)/$(PATH) $(OBJ_DIR)/$(BLT_IN) $(OBJ_DIR)/$(BLT_IN_UTL) \
...
SRC = main.c main_utils \
		...
		$(PATH)/get_path.c $(PATH)/path_utils.c \
